...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"./pkg/apis/spinnaker/v1alpha1.SpinnakerAccount":             schema_pkg_apis_spinnaker_v1alpha1_SpinnakerAccount(ref),
		"./pkg/apis/spinnaker/v1alpha1.SpinnakerAccountSpec":         schema_pkg_apis_spinnaker_v1alpha1_SpinnakerAccountSpec(ref),
		"./pkg/apis/spinnaker/v1alpha1.SpinnakerAccountStatus":       schema_pkg_apis_spinnaker_v1alpha1_SpinnakerAccountStatus(ref),
...
func schema_pkg_apis_spinnaker_v1alpha1_SpinnakerAccount(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/spinnaker/v1alpha1.SpinnakerAccountSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("./pkg/apis/spinnaker/v1alpha1.SpinnakerAccountStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"./pkg/apis/spinnaker/v1alpha1.SpinnakerAccountSpec", "./pkg/apis/spinnaker/v1alpha1.SpinnakerAccountStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_spinnaker_v1alpha1_SpinnakerAccountSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_spinnaker_v1alpha1_SpinnakerAccountStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
