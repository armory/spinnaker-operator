...
func (in *SpinnakerValidation) DeepCopyInto(out *SpinnakerValidation) {
	*out = *in
	if in.ValidationSetting != nil {
		in, out := &in.ValidationSetting, &out.ValidationSetting
		*out = new(ValidationSetting)
		**out = **in
	}
	if in.Providers != nil {
		in, out := &in.Providers, &out.Providers
		*out = make([]ValidationSettingList, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PersistentStoage != nil {
		in, out := &in.PersistentStoage, &out.PersistentStoage
		*out = new(ValidationSetting)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ValidationSettingList) DeepCopyInto(out *ValidationSettingList) {
	*out = *in
	if in.ValidationSetting != nil {
		in, out := &in.ValidationSetting, &out.ValidationSetting
		*out = new(ValidationSetting)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ValidationSettingList.
func (in *ValidationSettingList) DeepCopy() *ValidationSettingList {
	if in == nil {
		return nil
	}
	out := new(ValidationSettingList)
	in.DeepCopyInto(out)
	return out
}
