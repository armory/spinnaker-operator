...
import (
	...
	"github.com/armory/spinnaker-operator/pkg/api/deploy"
	"github.com/armory/spinnaker-operator/pkg/api/deploy/spindeploy/changedetector"
	"github.com/armory/spinnaker-operator/pkg/api/deploy/spindeploy/config"
	"github.com/armory/spinnaker-operator/pkg/api/deploy/spindeploy/expose_ingress"
	...
	"github.com/armory/spinnaker-operator/pkg/api/deploy/spindeploy/x509"
